...
begin
    ...
    Add_Sub_Sel_Internal <= Instruction_Bus(10);
    Jmp_AD_Internal <= Instruction_Bus(2 downto 0);
    Jmp_Flag_Internal <= Instruction_Bus(10) and Instruction_Bus(11) and not(Reg_C_Jump(0) or Reg_C_Jump(1) or Reg_C_Jump(2) or Reg_C_Jump(3));
