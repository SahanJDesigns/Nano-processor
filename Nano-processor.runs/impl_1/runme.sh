...
HD_PWD='D:/Sem 02/Computer Organization and Degital Design/Nano-processor/Nano-processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LUT_8_12.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LUT_8_12.tcl -notrace
