...
HD_PWD='C:/Users/sahan/OneDrive/Desktop/Nano-processor/Nano-processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Instruction_Reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Instruction_Reg.tcl
