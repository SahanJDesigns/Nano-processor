...
HD_PWD='D:/Sem 02/Computer Organization and Degital Design/Nano-processor/Nano-processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LUT_8_12.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LUT_8_12.tcl
